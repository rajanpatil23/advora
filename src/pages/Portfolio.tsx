  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main>
        ...
        {/* Projects Grid - Product-style cards */}
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* image frame */}
                  <div className="relative overflow-hidden rounded-[15px] bg-white p-3 sm:p-4 dark:bg-card">
                    <img
                      src={project.image}
                      alt={project.title}
                      loading="lazy"
                      decoding="async"
                      className="block h-auto w-full rounded-[10px] object-cover aspect-[16/10]"
                    />
                    {/* Floating results pill */}
                    <span className="absolute top-5 sm:top-6 right-5 sm:right-6 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-primary/15 backdrop-blur-sm border border-primary/30 text-[11px] font-semibold text-primary">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
                      {project.results}
                    </span>
                  </div>
